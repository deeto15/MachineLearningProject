...
class BertIntentClassifier:
    def __init__(self, model_path="./Binary_Classifier/training_models/classifier-bert-V3"):
...
def load_model(model_path="./Binary_Classifier/training_models/classifier-bert-V3"):
